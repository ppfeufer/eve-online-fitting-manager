 ...
 */
namespace WordPress\Plugin\EveOnlineFittingManager\Libs\Esi;
...
class Swagger {
     ...
     * Remote Helper
     *
     * @var \WordPress\Plugin\EveOnlineFittingManager\Libs\Helper\RemoteHelper
     */
    ...
    public function __construct() {
        $this->remoteHelper = \WordPress\Plugin\EveOnlineFittingManager\Libs\Helper\RemoteHelper::getInstance();
    }
    ...
    public function callEsi() {
        if(!\is_a($this->remoteHelper, '\WordPress\Plugin\EveOnlineFittingManager\Libs\Helper\RemoteHelper')) {
            $this->remoteHelper = \WordPress\Plugin\EveOnlineFittingManager\Libs\Helper\RemoteHelper::getInstance();
        }
