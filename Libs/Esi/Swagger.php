...
namespace WordPress\Plugins\EveOnlineFittingManager\Libs\Esi;
...
class Swagger {
    ...
    public function __construct() {
        $this->remoteHelper = \WordPress\Plugins\EveOnlineFittingManager\Libs\Helper\RemoteHelper::getInstance();
    }
    ...
    public function callEsi() {
        ...
        if(!\is_a($this->remoteHelper, '\WordPress\Plugins\EveOnlineFittingManager\Libs\Helper\RemoteHelper')) {
            $this->remoteHelper = \WordPress\Plugins\EveOnlineFittingManager\Libs\Helper\RemoteHelper::getInstance();
        }
