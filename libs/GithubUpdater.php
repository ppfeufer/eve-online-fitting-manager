...
class GithubPluginUpdater {
	...
	public function setPluginInfo($false, $action, $response) {
		...
		require_once(\plugin_dir_path(__FILE__) . 'GithubMarkupParser.php');

		// Create tabs in the lightbox
		$response->sections = array(
			'description' => $this->pluginData["Description"],
			'changelog' => \class_exists('GithubMarkupParser') ? GithubMarkupParser::instance()->parse($this->githubAPIResult->body) : $this->githubAPIResult->body
		);
